...
public class OrderService {
    ...
    @Transactional
    public void receiveNotification(String orderHash, TransactionNotificationDto notificationDto, String serverAddr) {
        Order order = getOrderByOrderHash(orderHash);
        String status = paymentMethodP24.receiveNotification(order, notificationDto, serverAddr);
